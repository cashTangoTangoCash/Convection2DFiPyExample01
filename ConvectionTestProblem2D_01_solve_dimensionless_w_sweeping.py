...
#head
logLevel='INFO'
logFilename='convectionTestProblem2D_01_solve_dimensionless.log'
...
if not showViewer:
    ...
    ax.set_xlabel(r'$r/R_i$',fontsize=22)
    ax.set_ylabel(r'$(T-T_i)/(T_\infty-T_i)$',fontsize=22)  #T_i is initial temperature and T_a is T_infinity for convection BC
...
for step in range(steps):
    ...
    if res>resTol:
        logging.error('unable to sweep to tolerance at step %d; quitting' % step)
        sys.exit()
